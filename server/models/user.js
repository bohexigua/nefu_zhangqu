...
const getUserInfo = async (username, password) => {
  ...
  const sql2 = 'select c.user_no, c.user_name, c.user_sex, c.user_college, c.user_img, ui.user_phone, ui.user_mail from user u, campus_info c, user_info ui where u.user_name = ? and u.user_pwd = ? and c.user_no = ? and ui.user_no = c.user_no';
